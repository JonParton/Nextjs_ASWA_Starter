  ...
  <div className="home">
    ...
    <div className="card-grid">
      ...
      <a className="card-small" href={`/project/projects`}>
        <h3>Projects</h3>
        <p>An example of pre-rendered pages which could be usefull for things like blogs or slowly changing data such as tornament results.</p>
      </a>
      <a className="card-small" href={`/about`}>
        <h3>About</h3>
        <p>An example of a completely static page with that is prerendered and server super fast bu the Azure Static Web App</p>
      </a>
    </div>
  </div>
);
